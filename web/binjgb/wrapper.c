 ...
 *
 * This file is based on binjgb's src/emscripten/wrapper.c and keeps the
 * original MIT licensing. The Pokemon RGB web build overlays this copy during
 * packaging so the submodule itself stays pinned and clean.
 */
#include <assert.h>
#include <stdlib.h>
